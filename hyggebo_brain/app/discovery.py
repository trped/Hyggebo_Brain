...
def _publish_room_occupancy_sensors(mqtt: "MQTTClient") -> None:
    ...
    for room in DISCOVERY_ROOMS:
        ...
        config = {
            ...
            "state_topic": f"hyggebo_brain/sensor/room_{room}/state",
            "value_template": "{{ value_json.occupancy }}",
            "payload_on": "occupied",
            "payload_off": "clear",
            "device_class": "occupancy",
            "json_attributes_topic": f"hyggebo_brain/sensor/room_{room}/state",
            "json_attributes_template": "{{ value_json.attributes | tojson }}",
            "availability": {
                "topic": "hyggebo_brain/sensor/system/state",
...
def _publish_house_state_sensor(mqtt: "MQTTClient") -> None:
    ...
    config = {
        ...
        "state_topic": "hyggebo_brain/sensor/hus_tilstand/state",
        "value_template": "{{ value_json.state }}",
        "json_attributes_topic": "hyggebo_brain/sensor/hus_tilstand/state",
        "json_attributes_template": "{{ value_json.attributes | tojson }}",
        "icon": "mdi:home-heart",
        "availability": {
            "topic": "hyggebo_brain/sensor/system/state",
...
def _publish_time_of_day_sensor(mqtt: "MQTTClient") -> None:
    ...
    config = {
        ...
        "state_topic": "hyggebo_brain/sensor/tid_pa_dagen/state",
        "value_template": "{{ value_json.state }}",
...
def _publish_system_sensor(mqtt: "MQTTClient") -> None:
    ...
    config = {
        ...
        "state_topic": "hyggebo_brain/sensor/system/state",
        "value_template": "{{ value_json.state }}",
        "json_attributes_topic": "hyggebo_brain/sensor/system/state",
        "json_attributes_template": "{{ value_json.attributes | tojson }}",
        "icon": "mdi:brain",
        "device": DEVICE_INFO,
    }
